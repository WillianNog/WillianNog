...
- 📍 Atualmente em **São Paulo – SP**, aberto a vagas presenciais, híbridas ou remotas.
- 🎓 **7º período de Engenharia da Computação**.
- 📊 Estudando **Data Science pela EBAC** (formação em andamento).
- 🐍 Focado em **Python para dados**, análise, automação e aplicações simples de IA/ML.
- 🎯 Em busca de oportunidades como **Analista de Dados Jr**, **Python Jr**, **Data Science Jr** ou áreas relacionadas a **IA**.
- 💡 Gosto de resolver problemas reais com dados, automatizar tarefas e aprender coisas novas o tempo todo.
...
📚 **Áreas que estou estudando com mais foco:**

- Python para análise de dados (Pandas, manipulação de arquivos, automação);
- Fundamentos de **estatística** e **Machine Learning**;
- SQL e bancos de dados para consulta e análise;
...
> Se você trabalha com dados/IA em São Paulo ou remoto e estiver aberto a conversar sobre vagas Jr, estágio ou projetos, pode me chamar em qualquer um dos canais acima. 😄
